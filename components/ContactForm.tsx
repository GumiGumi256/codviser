    ...
    try {
      ...
      if (response.status === 200) {
        ...
        toast.success("Your message has been sent successfully!", {
          position: "top-right",
          autoClose: 2000,
        }); // Duration for the toast message (in milliseconds)
    ...
    <div>
      <div className="mx-auto max-w-screen-md text-center mb-6 lg:mb-10">
        ...
        <p className=" font-light regular-24 text-gray-50 p-2">
          ...
          creating innovative solutions tailored to your unique needs. Whether
          you're a startup or an established business, we're here to help you
          thrive in the digital world. Contact us today{" "}
        </p>
      </div>
      <div className="flex flex-col md:flex-row items-center">
        <form
          onSubmit={handleSubmit}
          className="md:max-w-[500px] w-full p-4 md:p-0 mx-auto text-gray-50  flex-1 mb-20"
        >
          <div className="mb-4 ">
